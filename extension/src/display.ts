...
import type { Locator, Src, Url } from "./common";
...
export class Binder {
    ...
    makeChild(
        parent: HTMLElement,
        name: string,
        classes: Array<CssClass> | null = null
    ): HTMLElement {
    ...
    async renderError(parent: HTMLElement, error: Error): Promise<void> {
    ...
    async render(
        ...
        const details = tags.includes("chrome")
            ? undefined
            : child(item, "details");
